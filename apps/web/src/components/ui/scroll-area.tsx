  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="size-full overflow-y-auto rounded-[inherit] outline-none transition-[color,box-shadow] focus-visible:outline-1 focus-visible:ring-[3px] focus-visible:ring-ring/50"
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
      <ScrollBar />
